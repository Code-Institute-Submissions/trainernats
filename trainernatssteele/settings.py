"""
Django settings for trainernatssteele project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'https://trainernatssteele.herokuapp.com/']
...
ROOT_URLCONF = 'trainernatssteele.urls'
...
WSGI_APPLICATION = 'trainernatssteele.wsgi.application'
